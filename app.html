...
<body>
  ...
  <!-- PORTADA -->
  <div class="card">
    <div class="tag">Tutordigital</div>
  ...
  <div class="modalOverlay" id="overlay" aria-hidden="true">
    <div class="modal" role="dialog" aria-modal="true" aria-label="Chat Tutordigital">

      <!-- HEADER DEL MODAL -->
      <div class="modalTop">
        <div>Tutordigital</div>
        <div>
  ...
  <div class="miniBar" id="miniBar" aria-hidden="true">
    <div class="label">Tutordigital</div>
    <input id="miniInput" type="text" placeholder="Escribe…" aria-label="Escribir mensaje" />
    <button class="openBtn" id="miniOpen" type="button">Enviar</button>
    <button class="maxMini iconBtn" id="miniMax" type="button" title="Maximizar">⤢</button>
    <button class="closeMini iconBtn" id="miniClose" type="button">×</button>
  </div>

  <script type="module" src="/assets/home/home.js"></script>
</body>
</html>
