...
// back arrow). No "add new grade" form — but each row keeps "Editar" (inline
// score input) and "×" (delete with confirmation), same endpoints as
// desktop's grade-drawer.js (PATCH/DELETE /api/v1/grades/:id).

import { parseScore } from "../../js/features/scoreValidation.js";
import { mtPatchGrade, mtDeleteGrade } from "./trimestreData.js";
