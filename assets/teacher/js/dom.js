export function cacheDashboardElements() {
  return {
    ...
    taskGradeTaskSelectField: document.getElementById("taskGradeTaskSelectField"),
    taskGradeTaskLabel: document.getElementById("taskGradeTaskLabel"),
    taskGradeTaskSelect: document.getElementById("taskGradeTaskSelect"),
    taskGradeStudentField: document.getElementById("taskGradeStudentField"),
    taskGradeStudentNameField: document.getElementById("taskGradeStudentNameField"),
    taskGradeStudentName: document.getElementById("taskGradeStudentName"),
