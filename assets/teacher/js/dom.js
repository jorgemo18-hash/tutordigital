export function cacheDashboardElements() {
  return {
    ...
    studentTabPending: document.getElementById("studentTabPending"),
    studentTabApproved: document.getElementById("studentTabApproved"),
    studentTabRejected: document.getElementById("studentTabRejected"),
    ...
    approveStudentModal: document.getElementById("approveStudentModal"),
    approveStudentForm: document.getElementById("approveStudentForm"),
    approveStudentName: document.getElementById("approveStudentName"),
    approveStudentGroup: document.getElementById("approveStudentGroup"),
    approveStudentConfirm: document.getElementById("approveStudentConfirm"),
    approveStudentError: document.getElementById("approveStudentError"),
    rejectStudentModal: document.getElementById("rejectStudentModal"),
    rejectStudentForm: document.getElementById("rejectStudentForm"),
    rejectStudentName: document.getElementById("rejectStudentName"),
    rejectStudentReason: document.getElementById("rejectStudentReason"),
    rejectStudentConfirm: document.getElementById("rejectStudentConfirm"),
    rejectStudentError: document.getElementById("rejectStudentError"),
    ...
    teacherAdminPanel: document.getElementById("teacherAdminPanel"),
    teacherReqTabPending: document.getElementById("teacherReqTabPending"),
    teacherReqTabApproved: document.getElementById("teacherReqTabApproved"),
    teacherRequestsList: document.getElementById("teacherRequestsList"),
    teacherRequestsEmpty: document.getElementById("teacherRequestsEmpty"),
    teacherRequestsError: document.getElementById("teacherRequestsError")
  };
}
