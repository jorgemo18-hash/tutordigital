...
export function openSessionModal(ctx, { studentId, dayKey, taskTitle, sessionId, taskId, readonly = false, dotColor = "pending", isAlreadyReviewed = false, autoMarkReviewed = false }) {
  openSessionDrawer(ctx, { studentId, dayKey, taskTitle, sessionId, taskId, readonly, dotColor, isAlreadyReviewed, autoMarkReviewed });
}
