...
// teacher mobile panel's mobileTeacherSheets.js.

import { pushBackGuard, popBackGuard } from "../../shared/js/mobileBackGuard.js";

function _closeSheetVisual(sheetEl, backdropEl) {
  sheetEl.classList.remove("ad-sheet--visible");
  backdropEl.classList.remove("ad-backdrop--visible");
  document.body.style.overflow = "";
}

export function openSheet(sheetEl, backdropEl) {
  backdropEl.classList.add("ad-backdrop--visible");
  requestAnimationFrame(() => sheetEl.classList.add("ad-sheet--visible"));
