...
async function loadTests() {
  const modules = [
    ...
    "./teacher/recursos/programacionPantalla.test.mjs",
    "./teacher/recursos/deberes.test.mjs",
    "./dictado.test.mjs",
    "./hojaPdf.test.mjs",
    "./hojaPdf/navegadorReutilizable.test.mjs",
    "./academiaAdminAbrirPdf.test.mjs",
    ...
    "./academiaHorario/textoDelCuadrante.test.mjs",
    "./academiaCuadrante/medidasCuadrantePdf.test.mjs",
    "./academiaCuadrante/cuadrantePdf.test.mjs",
    ...
    "./hoja/figuras.test.mjs",
    "./hoja/titulosDeBloque.test.mjs",
    "./hoja/foliosDeLaHoja.test.mjs",
    ...
    "./generadorEjercicios/ejemploResuelto.test.mjs",
    ...
    "./generadorEjercicios/recta.test.mjs",
    "./generadorEjercicios/catalogoDeBaterias.test.mjs",
    "./generadorEjercicios/montadorDeHoja.test.mjs",
    "./generadorEjercicios/cubreConceptos.test.mjs",
    "./generadorEjercicios/interpretePedido.test.mjs",
    ...
    "./academiaAlumnos/fichaCompara.test.mjs",
    ...
    "./academiaEnvio/registroEnvio.test.mjs",
    "./academiaEnvio/ultimoEnvioPorFamilia.test.mjs",
    ...
    "./academiaEnvio/replyToLlegaAResend.test.mjs",
    ...
    "./teacher/recursos/programacionCriterios.test.mjs",
    "./adjuntosHuerfanos.test.mjs",
