...
async function loadTests() {
  const modules = [
    ...
    "./academiaAdminInformeCardEnviar.test.mjs",
    "./academiaAdminEmailTextoPanel.test.mjs",
    "./academiaAdminElegirTipoEnvioDialog.test.mjs",
    "./academiaAdminReciboEditorEnviar.test.mjs",
    "./academiaAdminCabeceraEnviarTodos.test.mjs",
