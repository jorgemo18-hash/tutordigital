...
export const ALTURA_DE_LA_BATERIA_MM = {
  ...
  compara_tarifas: { minimo: 46.4, medio: 57.9, maximo: 57.9 },
  complementario_suplementario: { minimo: 40.1, medio: 46.7, maximo: 46.7 },
  completa_tabla_funcion: { minimo: 48.5, medio: 60.2, maximo: 60.2 },
  ...
  cuadrante: { minimo: 40.1, medio: 46.7, maximo: 46.7 },
  ...
  problemas_funcion_lineal: { minimo: 48.4, medio: 59.9, maximo: 59.9 },
